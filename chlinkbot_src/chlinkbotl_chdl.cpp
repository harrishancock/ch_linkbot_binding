...
EXPORTCH void CLinkbotL_getBatteryVoltage_chdl(void *varg) {
	ChInterp_t interp;
	ChVaList_t ap;
	class Linkbot *l;
	double *voltage;
...
EXPORTCH void CLinkbotL_getJointSafetyAngle_chdl(void *varg) {
	ChInterp_t interp;
	ChVaList_t ap;
	class Linkbot *l;
	double *angle;
...
EXPORTCH void CLinkbotL_getJointSafetyAngleTimeout_chdl(void *varg) {
	ChInterp_t interp;
	ChVaList_t ap;
	class Linkbot *l;
	double *timeout;
...
EXPORTCH void CLinkbotL_setJointSafetyAngle_chdl(void *varg) {
	ChInterp_t interp;
	ChVaList_t ap;
	class Linkbot *l;
	double angle;
...
EXPORTCH void CLinkbotL_setJointSafetyAngleTimeout_chdl(void *varg) {
	ChInterp_t interp;
	ChVaList_t ap;
	class Linkbot *l;
	double timeout;
...
EXPORTCH void CLinkbotL_recordAnglesBegin_chdl(void *varg) {
	...
	l->recordAnglesBegin(*time, *angle1, *angle2, angle3, seconds, 0x03, shiftData);
...
EXPORTCH void CLinkbotL_recordNoDataShift_chdl(void *varg) {
	ChInterp_t interp;
	ChVaList_t ap;
	class Linkbot *l;
